...
register("/cwsdk/schedulemanage/list", "GET")(handle_list)
register("/cwsdk/schedulemanage/add", "GET")(handle_add)
register("/cwsdk/schedulemanage/add", "POST")(handle_add)
register("/cwsdk/schedulemanage/save", "GET")(handle_save)
register("/cwsdk/schedulemanage/save", "POST")(handle_save)
register("/cwsdk/schedulemanage/switch", "POST")(handle_switch)
register("/cwsdk/schedulemanage/switch", "GET")(handle_switch)
